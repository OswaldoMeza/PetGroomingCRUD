...
namespace PetGrooming.Controllers
{
    public class PetController : Controller
    {
        ...
        public ActionResult Update(int id, string PetName, string PetColor, double PetWeight, string PetNotes)
        {
            ...
            SqlParameter[] parameters = new SqlParameter[5];//5 pieces of info passed though

            //Set the Parameters for the query
            parameters[0] = new SqlParameter("@id", id);
            parameters[1] = new SqlParameter("@PetName", PetName);
            parameters[2] = new SqlParameter("@PetWeight", PetWeight);
            parameters[3] = new SqlParameter("@PetColor", PetColor);
            parameters[4] = new SqlParameter("@PetNotes", PetNotes);
            
            //Execute the query we wrote
